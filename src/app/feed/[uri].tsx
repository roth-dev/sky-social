    ...
    const loadFeedData = async () => {
      try {
        ...
        const mockFeed: FeedDetails = {
          ...
          description:
            "A curated feed showcasing the best photography from the Bluesky community. Featuring landscape, portrait, street photography, and more.",
          avatar:
  ...
  const handleShare = async () => {
    try {
      const shareUrl = `https://bsky.app/profile/${
        feedData?.creator.handle
      }/feed/${feedData?.uri.split("/").pop()}`;
        ...
        <View style={styles.previewSection}>
          ...
          <View style={styles.previewPlaceholder}>
            <Text style={styles.previewText}>
              Feed content would be displayed here. This would show recent posts
              from this custom feed.
            </Text>
          </View>
        </View>
      </ScrollView>
